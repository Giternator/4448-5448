...
public class SLEditItem extends Activity {
    ...
    public void onResume() {
    	...
    	if (itemId != -1) {
            ...
            EditText editQuantity = (EditText) findViewById(R.id.sl_quantity);
            
            editName.setText(itemName);
            editPrice.setText(itemPrice.toString());
            editQuantity.setText(itemQuantity.toString());
        }
    }
	...
	public void onPause() {
		...
		if (saveData) {
			...
			EditText quantityEdit = (EditText) findViewById(R.id.sl_quantity);
